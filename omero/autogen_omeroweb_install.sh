...
(cd $WORKSPACE/omeroweb-install && $DOCVENV/bin/ansible-playbook ./.travis/../ansible/omeroweb-install-doc.yml -i ./.travis/../ansible/hosts/ubuntu2404-ice3.6 --extra-vars '{"clean": True, "web_session": True}')
